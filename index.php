        ...
        <div class="x-logged">
          ...
          <a href="https://t.me/ezsup_official" class="x-header-btn-support -in-logged " target="_blank" rel="noreferrer nofollow">
            <picture>
              ...
              <source type="image/png" srcset="./assets/images/ic-telegram-support.png"><img alt="หวยออนไลน์ สล็อตออนไลน์ แทงหวยออนไลน์ เว็บพนันออนไลน์" class="img-fluid -ic" width="120" height="39"
                src="./assets/images/ic-telegram-support.png">
            </picture>
            <picture>
              <source type="image/webp" srcset="./assets/images/ic-telegram-support-mobile.webp">
              <source type="image/png" srcset="./assets/images/ic-telegram-support-mobile.png"><img alt="หวยออนไลน์ สล็อตออนไลน์ แทงหวยออนไลน์ เว็บพนันออนไลน์" class="img-fluid -ic -mobile" width="28"
                height="28" src="./assets/images/ic-telegram-support-mobile.png">
            </picture>
          </a>
          ...
          <a href="https://lin.ee/ZpHnqdt" class="x-header-btn-support -in-logged " target="_blank" rel="noreferrer nofollow">
            <picture>
              ...
              <source type="image/png" srcset="./assets/images/ic-line-support.png"><img alt="หวยออนไลน์ สล็อตออนไลน์ แทงหวยออนไลน์ เว็บพนันออนไลน์" class="img-fluid -ic" width="120" height="39"
                src="./assets/images/ic-line-support.png">
            </picture>
            <picture>
              <source type="image/webp" srcset="./assets/images/ic-line-support-mobile.webp">
              <source type="image/png" srcset="./assets/images/ic-line-support-mobile.png"><img alt="หวยออนไลน์ สล็อตออนไลน์ แทงหวยออนไลน์ เว็บพนันออนไลน์" class="img-fluid -ic -mobile" width="28"
                height="28" src="./assets/images/ic-line-support-mobile.png">
            </picture>
          </a>
                ...
                <div class="x-menu-account-list-sidebar">
                  ...
                  <div class="x-modal-account-menu-mobile">
                    ...
                    <div class="-transaction-button-wrapper">
                      ...
                      <a class="x-transaction-button-v2 -in-sidebar -withdraw js-close-account-sidebar lazyload x-bg-position-center" href="javascript:void(0)" data-toggle="modal"
                        data-target="#withdrawModal" data-bgset="./assets/images/btn-withdraw-bg.png">
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item -account-link-social">
                        <button type="button" class="nav-link js-close-account-sidebar -account-link-social" data-toggle="modal" data-target="#linkSocialAccountModalMobile">
                          ...
                          <div class="-text-menu-wrapper">
                            <img alt="ข้อมูลบัญชี หวยออนไลน์ แทงหวยออนไลน์" class="img-fluid -icon-image" width="35" height="35" src="./assets/images/ic-account-menu-link-social-media.png">
                      ...
                      <li class="nav-item -account-pocket-farm">
                        <button type="button" class="nav-link js-close-account-sidebar -account-pocket-farm" data-toggle="modal" data-target="#pocketFarmModalMobile">
                          <img alt="PocketFarm ฝากดอก ออกผล ดอกเบี้ย 10% ง่ายๆ" class="img-fluid -icon-image" width="35" height="35" src="./assets/images/ic-account-menu-pocket-farm.png">
                      ...
                      <li class="nav-item -account-invitation">
                        <a class="nav-link -account-invitation" href="/invitation">
                          <img alt="แนะนำเพื่อน หวยออนไลน์ แทงหวยออนไลน์" class="img-fluid -icon-image" width="35" height="35" src="./assets/images/ic-account-menu-invitation.png">
                      ...
                      <li class="nav-item -account-bill-history">
                        <button type="button" class="nav-link js-close-account-sidebar -account-bill-history" data-toggle="modal" data-target="#billHistoryModalMobile">
                          <img alt="ประวัติ หวยออนไลน์ แทงหวยออนไลน์" class="img-fluid -icon-image" width="35" height="35" src="./assets/images/ic-account-menu-bill-history.png">
                      ...
                      <li class="nav-item -account-provider">
                        <button type="button" class="nav-link js-close-account-sidebar -account-provider" data-toggle="modal" data-target="#providerUserModalMobile">
                          <img alt="เข้าเล่นผ่านแอพ หวยออนไลน์ แทงหวยออนไลน์" class="img-fluid -icon-image" width="35" height="35" src="./assets/images/ic-account-menu-provider.png">
                      ...
                      <li class="nav-item -join-promotion">
                        <button type="button" class="nav-link js-close-account-sidebar -join-promotion" data-toggle="modal" data-target="#joinPromotionModalMobile">
                          <img alt="โปรโมชั่นที่เข้าร่วม หวยออนไลน์ แทงหวยออนไลน์" class="img-fluid -icon-image" width="35" height="35" src="./assets/images/ic-account-menu-promotion.png">
                      ...
                      <li class="nav-item -promotion-return-by-user">
                        <button type="button" class="nav-link js-close-account-sidebar -promotion-return-by-user" data-toggle="modal" data-target="#promotionReturnByUserModalMobile">
                          <img alt="โบนัสเพิ่ม ทุกสัปดาห์ หวยออนไลน์ แทงหวยออนไลน์" class="img-fluid -icon-image" width="35" height="35" src="./assets/images/ic-account-menu-bonus.png">
                      ...
                      <li class="nav-item -logout">
                        ...
                        <a class="nav-link js-require-confirm  -logout" href="/logout" data-title="ต้องการออกจากระบบ ?">
                          <img alt="ออกจากระบบ หวยออนไลน์ แทงหวยออนไลน์" class="img-fluid -icon-image" width="35" height="35" src="./assets/images/ic-account-menu-logout.png">
  ...
  <div id="main__content" data-bgset="./assets/images/index-bg.png" class="x-bg-position-center x-bg-index lazyloaded" style="background-image: url(&quot;./assets/images/index-bg.png&quot;);">
    <div class="js-replace-cover-seo-container">
      <div class="x-homepage-banner-container">
        <div
          data-slickable="{&quot;arrows&quot;:false,&quot;dots&quot;:true,&quot;slidesToShow&quot;:1,&quot;centerMode&quot;:true,&quot;infinite&quot;:true,&quot;autoplay&quot;:true,&quot;autoplaySpeed&quot;:4000,&quot;pauseOnHover&quot;:false,&quot;focusOnSelect&quot;:true,&quot;variableWidth&quot;:true,&quot;responsive&quot;:{&quot;sm&quot;:{&quot;fade&quot;:true,&quot;variableWidth&quot;:false,&quot;slidesToShow&quot;:1}}}"
          ...
          <div class="slick-list draggable" style="padding: 0px 50px;">
            <div class="slick-track" style="opacity: 1; width: 40000px; transform: translate3d(-3122px, 0px, 0px);">
              ...
              <div class="-slide-inner-wrapper -slick-item slick-slide" data-slick-index="0" aria-hidden="true" role="tabpanel" id="slick-slide00" aria-describedby="slick-slide-control00"
                tabindex="-1">
              ...
              <div class="-slide-inner-wrapper -slick-item slick-slide" data-slick-index="1" aria-hidden="true" role="tabpanel" id="slick-slide01" aria-describedby="slick-slide-control01"
                tabindex="-1">
              ...
              <div class="-slide-inner-wrapper -slick-item slick-slide" data-slick-index="2" aria-hidden="true" role="tabpanel" id="slick-slide02" aria-describedby="slick-slide-control02"
                tabindex="-1">
              ...
              <div class="-slide-inner-wrapper -slick-item slick-slide slick-current slick-active slick-center" data-slick-index="3" aria-hidden="false" role="tabpanel" id="slick-slide03"
              ...
              <div class="-slide-inner-wrapper -slick-item slick-slide" data-slick-index="4" aria-hidden="true" role="tabpanel" id="slick-slide04" aria-describedby="slick-slide-control04"
                tabindex="-1">
                <div class="-link-wrapper">
              ...
              <div class="-slide-inner-wrapper -slick-item slick-slide" data-slick-index="5" aria-hidden="true" role="tabpanel" id="slick-slide05" aria-describedby="slick-slide-control05"
                tabindex="-1">
              ...
              <div class="-slide-inner-wrapper -slick-item slick-slide" data-slick-index="6" aria-hidden="true" role="tabpanel" id="slick-slide06" aria-describedby="slick-slide-control06"
                tabindex="-1">
              ...
              <div class="-slide-inner-wrapper -slick-item slick-slide" data-slick-index="7" aria-hidden="true" role="tabpanel" id="slick-slide07" aria-describedby="slick-slide-control07"
                tabindex="-1">
    ...
    <div class="x-index-content-main-container -logged">
      ...
      <div class="x-quick-transaction-buttons js-quick-transaction-buttons ">
        ...
        <a class="btn -btn -promotion lazyload x-bg-position-center" href="/promotions" target="_blank" rel="noopener nofollow" data-bgset="./assets/images/btn-promotion-bg.png">
          <span class="-ic-wrapper"> <img alt="โปรโมชั่นสุดคุ้ม เพื่อลูกค้าคนสำคัญ" class="img-fluid -ic" width="40" height="40" src="./assets/images/ic-quick-transaction-button-promotion.png"></span>
        ...
        <button class="btn -btn -withdraw lazyload x-bg-position-center" data-toggle="modal" data-target="#withdrawModal" data-bgset="./assets/images/btn-withdraw-bg.png">
          <span class="-ic-wrapper"> <img alt="ถอนเงินง่ายๆ ด้วยระบบออโต้ การันตี เท่าไหร่ก็จ่าย" class="img-fluid -ic" width="40" height="40" src="./assets/images/ic-account-withdraw.png"></span>
            ...
            <ul class="navbar-nav">
              <li class="nav-item -provider-card-item -first">
                ...
                <a href="/casino">
                  ...
                  <img alt="Category casino first-banner" class="-img img-fluid ls-is-cached lazyloaded" width="400" height="580" data-src="./assets/images/index-casino-category-first-banner.png"
                    src="./assets/images/index-casino-category-first-banner.png">
                </a>
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-aesexy/ezs-wt-aesexy-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-aesexy/ezs-wt-aesexy-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-we/ezs-wt-we-vertical.png"
                        srcset="https://asset.cloudigame.co/build/admin/img/wt-we/ezs-wt-we-vertical.png"><img alt="wt-we cover image png" class="img-fluid -cover-img ls-is-cached lazyloaded"
                        width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-we/ezs-wt-we-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/sa-gaming/ezs-sa-gaming-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/sa-gaming/ezs-sa-gaming-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-mgp-live/ezs-wt-mgp-live-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-mgp-live/ezs-wt-mgp-live-vertical.png"
                ...
                <div class="x-game-list-item-macro-in-share js-game-list-toggle -big   " data-status="">
                  <div class="-inner-wrapper">
                    ...
                    <img alt="wt-eg cover image png" class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580"
                      data-src="https://asset.cloudigame.co/build/admin/img/wt-eg/ezs-wt-eg-vertical.png" src="https://asset.cloudigame.co/build/admin/img/wt-eg/ezs-wt-eg-vertical.png">
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-pt-live/ezs-wt-pt-live-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-pt-live/ezs-wt-pt-live-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-ppa-live/ezs-wt-ppa-live-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-ppa-live/ezs-wt-ppa-live-vertical.png"
            ...
            <ul class="navbar-nav">
              <li class="nav-item -provider-card-item -first">
                ...
                <a href="/pgsoft">
                  ...
                  <img alt="Category slot first-banner" class="-img img-fluid ls-is-cached lazyloaded" width="400" height="580" data-src="./assets/images/index-slot-category-first-banner.png"
                    src="./assets/images/index-slot-category-first-banner.png">
                </a>
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-ppa/ezs-wt-ppa-vertical.png"
                        srcset="https://asset.cloudigame.co/build/admin/img/wt-ppa/ezs-wt-ppa-vertical.png"><img alt="wt-ppa cover image png" class="img-fluid -cover-img ls-is-cached lazyloaded"
                        width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-ppa/ezs-wt-ppa-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-pg-soft/ezs-wt-pg-soft-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-pg-soft/ezs-wt-pg-soft-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-joker/ezs-wt-joker-vertical.png"
                        srcset="https://asset.cloudigame.co/build/admin/img/wt-joker/ezs-wt-joker-vertical.png"><img alt="wt-joker cover image png" class="img-fluid -cover-img ls-is-cached lazyloaded"
                        width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-joker/ezs-wt-joker-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-fa-chai/ezs-wt-fa-chai-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-fa-chai/ezs-wt-fa-chai-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-cq9/ezs-wt-cq9-vertical.png"
                        srcset="https://asset.cloudigame.co/build/admin/img/wt-cq9/ezs-wt-cq9-vertical.png"><img alt="wt-cq9 cover image png" class="img-fluid -cover-img ls-is-cached lazyloaded"
                        width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-cq9/ezs-wt-cq9-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wtm-spinix/ezs-wtm-spinix-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wtm-spinix/ezs-wtm-spinix-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-mgp-slot/ezs-wt-mgp-slot-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-mgp-slot/ezs-wt-mgp-slot-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-evo-play/ezs-wt-evo-play-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-evo-play/ezs-wt-evo-play-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-ps/ezs-wt-ps-vertical.png"
                        srcset="https://asset.cloudigame.co/build/admin/img/wt-ps/ezs-wt-ps-vertical.png"><img alt="wt-ps cover image png" class="img-fluid -cover-img ls-is-cached lazyloaded"
                        width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-ps/ezs-wt-ps-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-red-tiger/ezs-wt-red-tiger-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-red-tiger/ezs-wt-red-tiger-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-habanero/ezs-wt-habanero-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-habanero/ezs-wt-habanero-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-mpoker/ezs-wt-mpoker-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-mpoker/ezs-wt-mpoker-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-play-tech/ezs-wt-play-tech-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-play-tech/ezs-wt-play-tech-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-goldy/ezs-wt-goldy-vertical.png"
                        srcset="https://asset.cloudigame.co/build/admin/img/wt-goldy/ezs-wt-goldy-vertical.png"><img alt="wt-goldy cover image png" class="img-fluid -cover-img ls-is-cached lazyloaded"
                        width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-goldy/ezs-wt-goldy-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-kalamba/ezs-wt-kalamba-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-kalamba/ezs-wt-kalamba-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-only-play/ezs-wt-only-play-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-only-play/ezs-wt-only-play-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-wm-slot/ezs-wt-wm-slot-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-wm-slot/ezs-wt-wm-slot-vertical.png"
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/sp/ezs-sp-vertical.png"
                        srcset="https://asset.cloudigame.co/build/admin/img/sp/ezs-sp-vertical.png"><img alt="sp cover image png" class="img-fluid -cover-img ls-is-cached lazyloaded" width="400"
                        height="580" data-src="https://asset.cloudigame.co/build/admin/img/sp/ezs-sp-vertical.png" src="https://asset.cloudigame.co/build/admin/img/sp/ezs-sp-vertical.png">
                    </picture>
                  ...
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/wt-rich88/ezs-wt-rich88-vertical.png"
                        ...
                        class="img-fluid -cover-img ls-is-cached lazyloaded" width="400" height="580" data-src="https://asset.cloudigame.co/build/admin/img/wt-rich88/ezs-wt-rich88-vertical.png"
                ...
                <div class="x-game-list-item-macro-in-share js-game-list-toggle -big-with-countdown-dark   " data-status="">
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/ez-lotto/game1234-vertical-countdown-dark.png"><img alt="lotto cover image png"
                        class="img-fluid lazyload -cover-img" width="456" height="714" data-src="https://asset.cloudigame.co/build/admin/img/ez-lotto/game1234-vertical-countdown-dark.png"
                        src="https://asset.cloudigame.co/build/admin/img/ezl-default-loading-big-with-countdown.png">
                    </picture>
                    ...
                    <div class="-overlay">
                      <div class="-overlay-inner">
                        <div class="-wrapper-container">
                          <a href="/account/lobby/play?channelCode=lotto&amp;metadata%5Bgame_id%5D=game1234" class="js-account-approve-aware -btn -btn-play" target="_blank" rel="nofollow noopener">
                            <i class="fas fa-play"></i>
                            <span class="-text-btn">เข้าเล่น</span>
                          </a>
                        </div>
                ...
                <div class="x-game-list-item-macro-in-share js-game-list-toggle -big-with-countdown-dark   " data-status="">
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/ez-lotto/pingpong-vertical-countdown-dark.png"><img alt="lotto cover image png"
                        class="img-fluid lazyload -cover-img" width="456" height="714" data-src="https://asset.cloudigame.co/build/admin/img/ez-lotto/pingpong-vertical-countdown-dark.png"
                        src="https://asset.cloudigame.co/build/admin/img/ezl-default-loading-big-with-countdown.png">
                    </picture>
                    ...
                    <div class="-overlay">
                      <div class="-overlay-inner">
                        <div class="-wrapper-container">
                          <a href="/account/lobby/play?channelCode=lotto&amp;metadata%5Bgame_id%5D=pingpong" class="js-account-approve-aware -btn -btn-play" target="_blank" rel="nofollow noopener">
                            <i class="fas fa-play"></i>
                            <span class="-text-btn">เข้าเล่น</span>
                          </a>
                        </div>
                ...
                <div class="x-game-list-item-macro-in-share js-game-list-toggle -big-with-countdown-dark   " data-status="">
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/ez-lotto/pingpong-15-vertical-countdown-dark.png"><img alt="lotto cover image png"
                        class="img-fluid lazyload -cover-img" width="456" height="714" data-src="https://asset.cloudigame.co/build/admin/img/ez-lotto/pingpong-15-vertical-countdown-dark.png"
                        src="https://asset.cloudigame.co/build/admin/img/ezl-default-loading-big-with-countdown.png">
                    </picture>
                    ...
                    <div class="-overlay">
                      <div class="-overlay-inner">
                        <div class="-wrapper-container">
                          <a href="/account/lobby/play?channelCode=lotto&amp;metadata%5Bgame_id%5D=pingpong-15" class="js-account-approve-aware -btn -btn-play" target="_blank" rel="nofollow noopener">
                            <i class="fas fa-play"></i>
                            <span class="-text-btn">เข้าเล่น</span>
                          </a>
                        </div>
                ...
                <div class="x-game-list-item-macro-in-share js-game-list-toggle -big-with-countdown-dark   " data-status="">
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/ez-lotto/crypto-vertical-countdown-dark.png"><img alt="lotto cover image png"
                        class="img-fluid lazyload -cover-img" width="456" height="714" data-src="https://asset.cloudigame.co/build/admin/img/ez-lotto/crypto-vertical-countdown-dark.png"
                        src="https://asset.cloudigame.co/build/admin/img/ezl-default-loading-big-with-countdown.png">
                    </picture>
                    ...
                    <div class="-overlay">
                      <div class="-overlay-inner">
                        <div class="-wrapper-container">
                          <a href="/account/lobby/play?channelCode=lotto&amp;metadata%5Bgame_id%5D=crypto" class="js-account-approve-aware -btn -btn-play" target="_blank" rel="nofollow noopener">
                            <i class="fas fa-play"></i>
                            <span class="-text-btn">เข้าเล่น</span>
                          </a>
                        </div>
                ...
                <div class="x-game-list-item-macro-in-share js-game-list-toggle -big-with-countdown-dark   " data-status="">
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/ez-lotto/government-vertical-countdown-dark.png"><img alt="lotto cover image png"
                        class="img-fluid lazyload -cover-img" width="456" height="714" data-src="https://asset.cloudigame.co/build/admin/img/ez-lotto/government-vertical-countdown-dark.png"
                        src="https://asset.cloudigame.co/build/admin/img/ezl-default-loading-big-with-countdown.png">
                    </picture>
                    ...
                    <div class="-overlay">
                      <div class="-overlay-inner">
                        <div class="-wrapper-container">
                          <a href="/account/lobby/play?channelCode=lotto&amp;metadata%5Bgame_id%5D=government" class="js-account-approve-aware -btn -btn-play" target="_blank" rel="nofollow noopener">
                            <i class="fas fa-play"></i>
                            <span class="-text-btn">เข้าเล่น</span>
                          </a>
                        </div>
                ...
                <div class="x-game-list-item-macro-in-share js-game-list-toggle -big-with-countdown-dark   " data-status="">
                  <div class="-inner-wrapper">
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="https://asset.cloudigame.co/build/admin/img/ez-lotto/laos-vertical-countdown-dark.png"><img alt="lotto cover image png"
                        class="img-fluid lazyload -cover-img" width="456" height="714" data-src="https://asset.cloudigame.co/build/admin/img/ez-lotto/laos-vertical-countdown-dark.png"
                        src="https://asset.cloudigame.co/build/admin/img/ezl-default-loading-big-with-countdown.png">
                    </picture>
                    ...
                    <div class="-overlay">
                      <div class="-overlay-inner">
                        <div class="-wrapper-container">
                          <a href="/account/lobby/play?channelCode=lotto&amp;metadata%5Bgame_id%5D=laos" class="js-account-approve-aware -btn -btn-play" target="_blank" rel="nofollow noopener">
                            <i class="fas fa-play"></i>
                            <span class="-text-btn">เข้าเล่น</span>
                          </a>
                        </div>
            ...
            <div class="x-vertical-content">
              <div class="container-fluid">
                ...
                <div class="-vertical-content-wrapper -content-center">
                  <img alt="EZ casino vertical content image" class="-img-first img-fluid lazyload" width="1119" height="468" data-src="./assets/images/index-vertical-content-with-image-first.png"
                    ...
                    <div class="-article-list">
                      <article class="-article-item">
                        <picture>
                          ...
                          <source type="image/png" data-srcset="./assets/images/content-index-column-list-icon-1.png"><img alt="Content index icon 1 png" class="img-fluid lazyload -ic" width="90" height="90"
                            data-src="./assets/images/content-index-column-list-icon-1.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                        </picture>
                        <div class="-content">
                      ...
                      <article class="-article-item">
                        <picture>
                          ...
                          <source type="image/png" data-srcset="./assets/images/content-index-column-list-icon-2.png"><img alt="Content index icon 2 png" class="img-fluid lazyload -ic" width="90" height="90"
                            data-src="./assets/images/content-index-column-list-icon-2.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                        </picture>
                        <div class="-content">
                      ...
                      <article class="-article-item">
                        <picture>
                          ...
                          <source type="image/png" data-srcset="./assets/images/content-index-column-list-icon-3.png"><img alt="Content index icon 3 png" class="img-fluid lazyload -ic" width="90" height="90"
                            data-src="./assets/images/content-index-column-list-icon-3.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                        </picture>
                        <div class="-content">
          ...
          <div class="tab-pane fade " id="tab-content-2">
            ...
            <div class="x-vertical-content">
              <div class="container-fluid">
                ...
                <div class="-vertical-content-wrapper -content-center">
                  <img alt="EZ casino vertical content image" class="-img-first img-fluid lazyload" width="1119" height="468" data-src="./assets/images/ez-casino-index-privilege-banner.png"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    ...
                    <div class="-category-wrapper">
                      ...
                      <a href="/blogs?category=zean-sood" class="-btn-category ">
                        <picture>
                          ...
                          <source type="image/png" srcset="./assets/images/ic-blog-category-zean-sood.png"><img alt="icon ตำราเซียน" class="img-fluid -icon" width="38" height="38"
                            src="./assets/images/ic-blog-category-zean-sood.png">
                        </picture>

                        <picture>
                          <source type="image/webp" srcset="./assets/images/ic-blog-category-zean-sood.webp">
                          <source type="image/png" srcset="./assets/images/ic-blog-category-zean-sood.png"><img alt="icon active ตำราเซียน" class="img-fluid -icon -active" width="38" height="38"
                            src="./assets/images/ic-blog-category-zean-sood.png">
                        </picture>

                        <picture>
                          <source type="image/webp" srcset="./assets/images/blog-category-bg.webp">
                          <source type="image/png" srcset="./assets/images/blog-category-bg.png"><img alt="รูปพื้นหลัง blog category" class="img-fluid -bg" width="160" height="55"
                            src="./assets/images/blog-category-bg.png">
                        </picture>

                        <picture>
                          <source type="image/webp" srcset="./assets/images/blog-category-bg-active.webp">
                          <source type="image/png" srcset="./assets/images/blog-category-bg-active.png"><img alt="icon active เลขเด็ด" class="img-fluid -bg -active" width="160" height="55"
                            src="./assets/images/blog-category-bg-active.png">
                        </picture>
                      ...
                      <a href="/blogs?category=popular-casino" class="-btn-category ">
                        <picture>
                          ...
                          <source type="image/png" srcset="./assets/images/ic-blog-category-popular-casino.png"><img alt="icon Casino น่าเล่น" class="img-fluid -icon" width="38" height="38"
                            src="./assets/images/ic-blog-category-popular-casino.png">
                        </picture>

                        <picture>
                          <source type="image/webp" srcset="./assets/images/ic-blog-category-popular-casino.webp">
                          <source type="image/png" srcset="./assets/images/ic-blog-category-popular-casino.png"><img alt="icon active Casino น่าเล่น" class="img-fluid -icon -active" width="38" height="38"
                            src="./assets/images/ic-blog-category-popular-casino.png">
                        </picture>
                      ...
                      <a href="/blogs?category=super-shot" class="-btn-category ">
                        <picture>
                          ...
                          <source type="image/png" srcset="./assets/images/ic-blog-category-super-shot.png"><img alt="icon Shot แม่น" class="img-fluid -icon" width="38" height="38"
                            src="./assets/images/ic-blog-category-super-shot.png">
                        </picture>

                        <picture>
                          <source type="image/webp" srcset="./assets/images/ic-blog-category-super-shot.webp">
                          <source type="image/png" srcset="./assets/images/ic-blog-category-super-shot.png"><img alt="icon active Shot แม่น" class="img-fluid -icon -active" width="38" height="38"
                            src="./assets/images/ic-blog-category-super-shot.png">
                        </picture>
                      ...
                      <a href="/blogs?category=news-event" class="-btn-category ">
                        <picture>
                          ...
                          <source type="image/png" srcset="./assets/images/ic-blog-category-news-event.png"><img alt="icon Event" class="img-fluid -icon" width="38" height="38"
                            src="./assets/images/ic-blog-category-news-event.png">
                        </picture>

                        <picture>
                          <source type="image/webp" srcset="./assets/images/ic-blog-category-news-event.webp">
                          <source type="image/png" srcset="./assets/images/ic-blog-category-news-event.png"><img alt="icon active Event" class="img-fluid -icon -active" width="38" height="38"
                            src="./assets/images/ic-blog-category-news-event.png">
                        </picture>
                      ...
                      <a href="/blogs?category=news-lotto" class="-btn-category ">
                        ...
                        <picture>
                          <source type="image/webp" srcset="./assets/images/ic-blog-category-news-lotto.webp">
                          <source type="image/png" srcset="./assets/images/ic-blog-category-news-lotto.png"><img alt="icon active หวย" class="img-fluid -icon -active" width="38" height="38"
                            src="./assets/images/ic-blog-category-news-lotto.png">
                        </picture>
                      ...
                      <a href="/blogs?category=news-slot" class="-btn-category ">
                        <picture>
                          ...
                          <source type="image/png" srcset="./assets/images/ic-blog-category-news-slot.png"><img alt="icon สล็อต" class="img-fluid -icon" width="38" height="38"
                            src="./assets/images/ic-blog-category-news-slot.png">
                        </picture>

                        <picture>
                          <source type="image/webp" srcset="./assets/images/ic-blog-category-news-slot.webp">
                          <source type="image/png" srcset="./assets/images/ic-blog-category-news-slot.png"><img alt="icon active สล็อต" class="img-fluid -icon -active" width="38" height="38"
                            src="./assets/images/ic-blog-category-news-slot.png">
                        </picture>
                          ...
                          <a href="/Slots6666-A-super-fun-online-slot" class="-card-wrapper">
                            <div class="-card-image">
                              <img alt="สล็อต6666 - เกมสล็อตออนไลน์สุดมันส์รับโชคใหญ่" class="img-fluid -image lazyload" width="237" height="140"
                                data-src="./assets/images/b0a948d1c75a535f348ebf7c665de626.jpg" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </div>
                          ...
                          <a href="/live-casinos-a-hot-new-source-of-money-making" class="-card-wrapper">
                            <div class="-card-image">
                              <img alt="คาสิโนสด แหล่งทำเงินใหม่มาแรง ตอบโจทย์ทุกการเดิมพัน เต็มคำทุกกำไร" class="img-fluid -image lazyload" width="237" height="140"
                                data-src="./assets/images/858a14434491e3dda0981cc54e6cb1e6.jpg" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </div>
                      ...
                      <div class="col-sm-6 col-md-4 col-lg-3 -list-item">
                        ...
                        <div class="x-blog-card-list-item-container">
                          <a href="/Entrance-to-pg-soft-source" class="-card-wrapper">
                            <div class="-card-image">
                              <img alt="ทางเข้า pg soft แหล่งเกมสล็อตออนไลน์มาแรง" class="img-fluid -image lazyload" width="237" height="140" data-src="./assets/images/f5a2cfef862fb507e197376a36983405.jpg"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </div>
                          ...
                          <a href="/285casino-catches-every-eyes" class="-card-wrapper">
                            <div class="-card-image">
                              <img alt="285คาสิโน สะกดทุกสายตา ลงเดิมพันได้แบบนอนสต็อป ผู้ชนะแห่งโลกการพนัน" class="img-fluid -image lazyload" width="237" height="140"
                                data-src="./assets/images/fd616cb05fc51958d524894b0f5985a9.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </div>
                          ...
                          <a href="/reviews-and-promotions-online-casino-777" class="-card-wrapper">
                            <div class="-card-image">
                              <img alt="รีวิวและโปรโมชั่น คาสิโนออนไลน์777 พร้อมเคล็ดลับ" class="img-fluid -image lazyload" width="237" height="140"
                                data-src="./assets/images/b579b85f3a4f83f9b67739135db334e8.jpg" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </div>
                          ...
                          <a href="/online-casino-888-number-1" class="-card-wrapper">
                            <div class="-card-image">
                              <img alt="คาสิโนออนไลน์888 ยอดนิยมอันดับ 1 ที่มาแรงที่สุดในตอนนี้" class="img-fluid -image lazyload" width="237" height="140"
                                data-src="./assets/images/2c6eeca22eea46909318057800ff0053.jpg" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </div>
                          ...
                          <a href="/%E0%B9%80%E0%B8%A7%E0%B9%87%E0%B8%9A%E0%B8%9E%E0%B8%99%E0%B8%B1%E0%B8%99-285%E0%B8%84%E0%B8%B2%E0%B8%AA%E0%B8%B4%E0%B9%82%E0%B8%99-%E0%B8%99%E0%B9%88%E0%B8%B2%E0%B8%AA%E0%B8%99%E0%B9%83%E0%B8%88%E0%B8%A7%E0%B8%B2%E0%B8%87%E0%B9%80%E0%B8%87%E0%B8%B4%E0%B8%99%E0%B8%97%E0%B8%B8%E0%B8%99%E0%B9%80%E0%B8%94%E0%B8%B4%E0%B8%A1%E0%B8%9E%E0%B8%B1%E0%B8%99-10-%E0%B8%9A%E0%B8%B2%E0%B8%97-%E0%B9%80%E0%B8%A5%E0%B9%88%E0%B8%99%E0%B9%84%E0%B8%94%E0%B9%89%E0%B8%AA%E0%B8%9A"
                            ...
                            <div class="-card-image">
                              <img alt="เว็บพนัน 285คาสิโน น่าสนใจวางเงินทุนเดิมพัน 10 บาท เล่นได้สบายๆ" class="img-fluid -image lazyload" width="237" height="140"
                                data-src="./assets/images/dc446b4665435fd01a989cffa1a62f54.jpg" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </div>
                          ...
                          <a href="/auto-casino-baccarat-game" class="-card-wrapper">
                            <div class="-card-image">
                              <img alt="คาสิโนauto เกมบาคาร่า แจกสูตรเทคนิควิธีการเล่น ให้สำหรับสมาชิกทุกท่าน" class="img-fluid -image lazyload" width="237" height="140"
                                data-src="./assets/images/c91b9dd2673d4b2ca557603007650675.jpg" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </div>
              ...
              <div class="container">
                ...
                <div class="-accordion-list-wrapper accordion" id="questionAndAnswerAccordion">
                  <article class="-accordion-list-item-wrapper">
                    <h4 class="-btn " data-toggle="collapse" data-target="#questionAndAnswerAccordion-why-ez-casino" aria-expanded="1" aria-controls="questionAndAnswerAccordion-why-ez-casino">
                      ทำไมต้องเลือกเล่น EZ Casino?
                      <i class="fas fa-plus"></i>
                      <i class="fas fa-minus"></i>
                    </h4>
                    <div id="questionAndAnswerAccordion-why-ez-casino" class="collapse show js-q-and-a-article-content" aria-labelledby="headingOne" data-parent="#questionAndAnswerAccordion">
                  ...
                  <article class="-accordion-list-item-wrapper">
                    ...
                    <div id="questionAndAnswerAccordion-what-provider-popular" class="collapse js-q-and-a-article-content" aria-labelledby="headingOne" data-parent="#questionAndAnswerAccordion">
                  ...
                  <article class="-accordion-list-item-wrapper">
                    ...
                    <div id="questionAndAnswerAccordion-what-event-popular" class="collapse js-q-and-a-article-content" aria-labelledby="headingOne" data-parent="#questionAndAnswerAccordion">
                  ...
                  <article class="-accordion-list-item-wrapper">
                    ...
                    <div id="questionAndAnswerAccordion-how-long-deposit-withdraw" class="collapse js-q-and-a-article-content" aria-labelledby="headingOne" data-parent="#questionAndAnswerAccordion">
                      ...
                      <div class="-header">
                        ...
                        <div class="-star-rate-wrapper -small">
                          <div class="rating-container rating-xs rating-animate rating-disabled">
                            <div class="rating-stars"><span class="empty-stars"><span class="star"><i class="fas fa-star"></i></span><span class="star"><i class="fas fa-star"></i></span><span
                                  class="star"><i class="fas fa-star"></i></span><span class="star"><i class="fas fa-star"></i></span><span class="star"><i class="fas fa-star"></i></span></span><span
                                class="filled-stars" style="width: 100%;"><span class="star"><i class="fas fa-star"></i></span><span class="star"><i class="fas fa-star"></i></span><span
                                  class="star"><i class="fas fa-star"></i></span><span class="star"><i class="fas fa-star"></i></span><span class="star"><i class="fas fa-star"></i></span></span><input
                                type="hidden" value="5" data-star-rating="{&quot;step&quot;:1}" readonly="readonly" class="rating-input"></div>
                          </div>
                        </div>
                      </div>
    ...
    <div class="x-modal modal -v2 -alert-modal animated fadeInRight" id="alertModal" role="dialog" aria-hidden="true" data-loading-container=".js-modal-content" data-ajax-modal-always-reload="true"
      tabindex="-1" data-animatable="fadeInRight" data-delay="700" data-dismiss-alert="true">
            ...
            <div class="-theme-switcher-container">
              <div class="-inner-header-section">
                <a class="-link-wrapper" href="/">
                  <picture>
                    ...
                    <source type="image/png" data-srcset="./assets/images/logo.png"><img alt="logo image" class="img-fluid lazyload -logo lazyload" width="180" height="42" data-src="./assets/images/logo.png"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                  </picture>
                </a>
              </div>
              ...
              <div class="-inner-top-body-section">
                <div class="col-6 -wrapper-box">
                  ...
                  <button type="button" class="btn -btn-item x-transaction-button-v2 -deposit -top-btn -horizontal lazyload x-bg-position-center" data-toggle="modal" data-dismiss="modal"
                    data-target="#depositModal" data-bgset="./assets/images/btn-deposit-bg.png">
                    <picture>
                      <source type="image/webp" data-srcset="./assets/images/ic-account-deposit.webp">
                      <source type="image/png" data-srcset="./assets/images/ic-account-deposit.png"><img alt="รูปไอคอนฝากเงิน" class="img-fluid -icon-image lazyload" width="50" height="50"
                        data-src="./assets/images/ic-account-deposit.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </picture>
                ...
                <div class="col-6 -wrapper-box">
                  ...
                  <button type="button" class="btn -btn-item x-transaction-button-v2 -withdraw -top-btn -horizontal lazyload x-bg-position-center" data-toggle="modal" data-dismiss="modal"
                    data-target="#withdrawModal" data-bgset="./assets/images/btn-withdraw-bg.png">
                    <picture>
                      <source type="image/webp" data-srcset="./assets/images/ic-account-withdraw.webp">
                      <source type="image/png" data-srcset="./assets/images/ic-account-withdraw.png"><img alt="รูปไอคอนถอนเงิน" class="img-fluid -icon-image lazyload" width="50" height="50"
                        data-src="./assets/images/ic-account-withdraw.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </picture>
              ...
              <div class="-inner-center-body-section">
                <div class="col-6 -wrapper-box">
                  ...
                  <a href="/event" class="btn -btn-item -event-button -menu-center -horizontal lazyload x-bg-position-center" data-bgset="./assets/images/theme-switcher-middle-btn-bg.png">
                    <picture>
                      <source type="image/webp" data-srcset="./assets/images/ic-modal-menu-event.webp">
                      <source type="image/png" data-srcset="./assets/images/ic-modal-menu-event.png"><img alt="รูปไอคอนสิทธิพิเศษ" class="img-fluid -icon-image lazyload" width="65" height="53"
                        data-src="./assets/images/ic-modal-menu-event.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </picture>
                ...
                <div class="col-6 -wrapper-box">
                  ...
                  <a href="/promotions" class="btn -btn-item -promotion-button -menu-center -horizontal lazyload x-bg-position-center" data-bgset="./assets/images/theme-switcher-middle-btn-bg.png">
                    <picture>
                      <source type="image/webp" data-srcset="./assets/images/ic-modal-menu-promotion.webp">
                      <source type="image/png" data-srcset="./assets/images/ic-modal-menu-promotion.png"><img alt="รูปไอคอนโปรโมชั่น" class="img-fluid -icon-image lazyload" width="65" height="53"
                        data-src="./assets/images/ic-modal-menu-promotion.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </picture>
                ...
                <div class="col-6 -wrapper-box">
                  ...
                  <a href="https://ezmovie.co/" class="btn -btn-item -movie-button -menu-center -horizontal lazyload x-bg-position-center" target="_blank" rel="noopener nofollow"
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="./assets/images/ic-modal-menu-movie.png"><img alt="รูปไอคอนดูหนัง" class="img-fluid -icon-image lazyload" width="65" height="53"
                        data-src="./assets/images/ic-modal-menu-movie.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </picture>
                ...
                <div class="col-6 -wrapper-box">
                  ...
                  <a href="https://lin.ee/ZpHnqdt" class="btn -btn-item -line-button -menu-center -horizontal lazyload x-bg-position-center" target="_blank" rel="noopener nofollow"
                    ...
                    <picture>
                      ...
                      <source type="image/png" data-srcset="./assets/images/ic-modal-menu-line.png"><img alt="รูปไอคอนดูหนัง" class="img-fluid -icon-image lazyload" width="65" height="53"
                        data-src="./assets/images/ic-modal-menu-line.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </picture>
              ...
              <div class="-inner-bottom-body-section">
                <div class="col-12 -wrapper-box">
                  ...
                  <a href="#share1theme-switcher" class="btn -btn-item -social-share-button -menu-banner  " data-ajax-modal-ondemand-user="social-share-modal-1" data-force="true" data-x-dismiss="true"
                    data-parent-class-selector="x-social-share-main-modal -v2" data-url="/account/_ajax_/social-share-submit/1/create">
                    <picture>
                      <source type="image/webp" data-srcset="./assets/images/menu-banner-social-share.webp">
                      <source type="image/png" data-srcset="./assets/images/menu-banner-social-share.png"><img alt="รูปแบนเนอร์แชร์แลกทรัพย์" class="img-fluid -banner-image lazyload" width="342" height="98"
                        data-src="./assets/images/menu-banner-social-share.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </picture>
                ...
                <div class="col-12 -wrapper-box">
                  ...
                  <a href="#0" class="btn -btn-item -bookmark-button -menu-banner  js-add-to-home-screen">
                    <picture>
                      ...
                      <source type="image/png" data-srcset="./assets/images/menu-banner-bookmark.png"><img alt="รูปแบนเนอร์ bookmark" class="img-fluid -banner-image lazyload" width="342" height="98"
                        data-src="./assets/images/menu-banner-bookmark.png" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </picture>
              ...
              <div class="tab-content x-bookmark-tabs-content-wrapper" id="nav-tabContent">
                ...
                <div class="tab-pane fade " id="nav-android" role="tabpanel" aria-labelledby="nav-android-tab">
                  <div class="-slide-wrapper -bookmark-slider-for-android slick-initialized slick-slider slick-dotted"
                      ...
                      <div class="slick-track" style="opacity: 1; width: 0px;">
                        <div class="-slide-inner-wrapper slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false"
                          ...
                          <picture>
                            ...
                            <img class="-img lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="253" height="513" data-src="./assets/images/bookmark-android-1.png"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                          </picture>
                        </div>
                        <div class="-slide-inner-wrapper slick-slide" data-slick-index="1" aria-hidden="true" style="width: 0px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0;"
                          ...
                          <picture>
                            ...
                            <img class="-img lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="253" height="513" data-src="./assets/images/bookmark-android-2.png"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                          </picture>
                        </div>
                        <div class="-slide-inner-wrapper slick-slide" data-slick-index="2" aria-hidden="true" style="width: 0px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0;"
                          ...
                          <picture>
                            ...
                            <img class="-img lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="253" height="513" data-src="./assets/images/bookmark-android-3.png"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                          </picture>
                        </div>
                      </div>
                    ...
                    <ul class="slick-dots" style="" role="tablist">
                      <li class="slick-active" role="presentation"><button type="button" role="tab" id="slick-slide-control10" aria-controls="slick-slide10" aria-label="1 of 3" tabindex="0"
                          aria-selected="true">1</button></li>
                      <li role="presentation"><button type="button" role="tab" id="slick-slide-control11" aria-controls="slick-slide11" aria-label="2 of 3" tabindex="-1">2</button></li>
                      <li role="presentation"><button type="button" role="tab" id="slick-slide-control12" aria-controls="slick-slide12" aria-label="3 of 3" tabindex="-1">3</button></li>
                    </ul>
                  </div>
                        ...
                        <div class="-slide-inner-wrapper slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false"
                          ...
                          <div class="-content-wrapper -center">
                            ...
                            <picture>
                              ...
                              <img class="-icon lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="60" height="60" data-src="./assets/images/bookmark-slide-number-1.png"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </picture>
                        ...
                        <div class="-slide-inner-wrapper slick-slide" data-slick-index="1" aria-hidden="true" style="width: 0px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0;"
                          ...
                          <div class="-content-wrapper -center">
                            ...
                            <picture>
                              ...
                              <img class="-icon lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="60" height="60" data-src="./assets/images/bookmark-slide-number-2.png"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </picture>
                        ...
                        <div class="-slide-inner-wrapper slick-slide" data-slick-index="2" aria-hidden="true" style="width: 0px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0;"
                          ...
                          <div class="-content-wrapper -center">
                            ...
                            <picture>
                              ...
                              <img class="-icon lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="60" height="60" data-src="./assets/images/bookmark-slide-number-3.png"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </picture>
                ...
                <div class="tab-pane fade show active" id="nav-ios" role="tabpanel" aria-labelledby="nav-ios-tab">
                  <div class="-slide-wrapper -bookmark-slider-for-ios slick-initialized slick-slider slick-dotted"
                      ...
                      <div class="slick-track" style="opacity: 1; width: 0px;">
                        <div class="-slide-inner-wrapper slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false"
                          ...
                          <picture>
                            ...
                            <img class="-img lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="253" height="513" data-src="./assets/images/bookmark-ios-1.png"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                          </picture>
                        </div>
                        <div class="-slide-inner-wrapper slick-slide" data-slick-index="1" aria-hidden="true" style="width: 0px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0;"
                          tabindex="-1" role="tabpanel" id="slick-slide31">
                          ...
                          <picture>
                            ...
                            <img class="-img lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="253" height="513" data-src="./assets/images/bookmark-ios-2.png"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                          </picture>
                        </div>
                        <div class="-slide-inner-wrapper slick-slide" data-slick-index="2" aria-hidden="true" style="width: 0px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0;"
                          tabindex="-1" role="tabpanel" id="slick-slide32">
                          ...
                          <picture>
                            ...
                            <img class="-img lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="253" height="513" data-src="./assets/images/bookmark-ios-3.png"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                          </picture>
                        </div>
                        <div class="-slide-inner-wrapper slick-slide" data-slick-index="3" aria-hidden="true" style="width: 0px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0;"
                          tabindex="-1" role="tabpanel" id="slick-slide33">
                          ...
                          <picture>
                            ...
                            <img class="-img lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="253" height="513" data-src="./assets/images/bookmark-ios-4.png"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                          </picture>
                        </div>
                      </div>
                    ...
                    <ul class="slick-dots" style="" role="tablist">
                      <li class="slick-active" role="presentation"><button type="button" role="tab" id="slick-slide-control30" aria-controls="slick-slide30" aria-label="1 of 4" tabindex="0"
                          aria-selected="true">1</button></li>
                      <li role="presentation"><button type="button" role="tab" id="slick-slide-control31" aria-controls="slick-slide31" aria-label="2 of 4" tabindex="-1">2</button></li>
                        ...
                        <div class="-slide-inner-wrapper slick-slide" data-slick-index="3" aria-hidden="true" style="width: 0px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0;"
                          ...
                          <div class="-content-wrapper -center">
                            ...
                            <picture>
                              ...
                              <img class="-icon lazyload" alt="บาคาร่าออนไลน์ คาสิโนออนไลน์ อันดับ 1 ของไทย" width="60" height="60" data-src="./assets/images/bookmark-slide-number-4.png"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </picture>
                            <div class="-description">ตรวจสอบหน้า <br> โฮมสกรีนว่ามีไอคอนขึ้นแล้ว</div>
                          </div>
              ...
              <ul class="nav x-website-menu-entry-list -as-vertical">
                ...
                <li class="nav-item -nav-item">
                  <a class="nav-link -nav-link" href="/reviews">
                    ...
                    <img alt="บาคาร่าออนไลน์ สล็อตออนไลน์ อันดับหนึ่งในประเทศไทย" class="img-fluid lazyload -img" width="50" height="50" data-src="./assets/images/ic-website-menu-review.png"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                ...
                <li class="nav-item -nav-item">
                  <a class="nav-link -nav-link" href="https://ezmovie.co" target="_blank" rel="noopener nofollow">
                    ...
                    <img alt="บาคาร่าออนไลน์ สล็อตออนไลน์ อันดับหนึ่งในประเทศไทย" class="img-fluid lazyload -img" width="50" height="50" data-src="./assets/images/ic-website-menu-movie.png"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                ...
                <li class="nav-item -nav-item">
                  <a class="nav-link -nav-link" href="/promotions">
                    ...
                    <img alt="บาคาร่าออนไลน์ สล็อตออนไลน์ อันดับหนึ่งในประเทศไทย" class="img-fluid lazyload -img" width="50" height="50" data-src="./assets/images/ic-website-menu-promotion.png"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                ...
                <li class="nav-item -nav-item">
                  <a class="nav-link -nav-link" href="/event">
                    ...
                    <img alt="บาคาร่าออนไลน์ สล็อตออนไลน์ อันดับหนึ่งในประเทศไทย" class="img-fluid lazyload -img" width="50" height="50" data-src="./assets/images/ic-website-menu-event.png"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                ...
                <li class="nav-item -nav-item">
                  <a class="nav-link -nav-link" href="/blogs">
                    ...
                    <img alt="บาคาร่าออนไลน์ สล็อตออนไลน์ อันดับหนึ่งในประเทศไทย" class="img-fluid lazyload -img" width="50" height="50" data-src="./assets/images/ic-website-menu-blog.png"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
    ...
    <div class="x-modal modal -v2 -with-more-than-half-size" id="joinPromotionModalMobile" role="dialog" aria-hidden="true" data-loading-container=".modal-body" data-ajax-modal-always-reload="true"
      tabindex="-1" data-ajax-modal="/account/_ajax_/promotion?isMobileView=1" data-container="#joinPromotionModalMobile">
      <div class="modal-dialog -modal-size -v2 modal-dialog-centered modal-dialog-scrollable " role="document">
        <div class="modal-content -modal-content">
          <button type="button" class="close f-1 " data-dismiss="modal" aria-label="Close">
            <i class="fas fa-times"></i>
    ...
    <div class="x-modal modal -v2 -with-more-than-half-size" id="withdrawModal" role="dialog" aria-hidden="true" data-loading-container=".modal-body" data-ajax-modal-always-reload="true" tabindex="-1"
      data-ajax-modal="/account/_ajax_/withdraw" data-container="#withdrawModal">
      <div class="modal-dialog -modal-size -v2 modal-dialog-centered modal-dialog-scrollable " role="document">
        <div class="modal-content -modal-content">
          <button type="button" class="close f-1 " data-dismiss="modal" aria-label="Close">
            <i class="fas fa-times"></i>
              ...
              <ul class="nav -menu-wrapper">
                ...
                <li class="nav-item">
                  <button data-target="#accountModal" data-toggle="modal" data-dismiss="modal" class="-option-button" data-to-ajax-account-modal="/account/_ajax_/pocket-farm">
                    <div class="-img-wrapper">
                      <img alt="คาสิโนออนไลน์ สล็อตออนไลน์ บาคาร่าออนไลน์ อันดับ 1" class="img-fluid lazyload -img" width="40" height="40" data-src="./assets/images/ic-withdraw-option-pocket-farm.png"
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </div>
                ...
                <li class="nav-item">
                  <button data-target="#withdrawModal" data-toggle="modal" data-dismiss="modal" class="-option-button">
                    <div class="-img-wrapper">
                      <img alt="คาสิโนออนไลน์ สล็อตออนไลน์ บาคาร่าออนไลน์ อันดับ 1" class="img-fluid lazyload -img" width="40" height="40" data-src="./assets/images/ic-withdraw-option-withdraw.png"
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                    </div>
                    ...
                    <div class="x-tab-confirm-request">
                      ...
                      <div class="x-reset-pw-text-container ">
                        <form method="post" data-register-v3-form="/_ajax_/v3/reset-password/request-otp" data-register-step="resetPasswordPhoneNumber"
                          ...
                          <input type="hidden" required="" id="phone_number[phoneNumber]" name="phone_number[phoneNumber]" pattern=".{10,11}" value="0929651369" placeholder="095-123-4567">
                          ...
                          <div class="x-modal-separator-container x-form-register">
                            <div class="-top ">
                              ...
                              <div data-animatable="fadeInRegister" data-offset="0" class="-animatable-container -otp-body animated fadeInRegister">
                                <form method="post" data-register-v3-form="/_ajax_/v3/reset-password/verify-otp/_resetPasswordToken" data-register-step="resetPasswordVerifyOtp"
                                  data-tab-next-step="#tab-content-logged-resetPasswordSetPassword" name="js-reset-password-v3-otp-form">
                                  <div class="d-flex -otp-input-container js-register-v3-input-group">
                                    ...
                                    <div class="js-separator-container js-login-reset-password-otp-container">
                                      <input type="text" id="resetPasswordOtp0" name="otp0" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1" class="-digit-otp js-otp-input"
                                        data-separator-input="true" data-type="otp">
                                    </div>


                                    <div class="js-separator-container js-login-reset-password-otp-container">
                                      <input type="text" id="resetPasswordOtp1" name="otp1" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1" class="-digit-otp js-otp-input"
                                        data-separator-input="true" data-type="otp">
                                    </div>


                                    <div class="js-separator-container js-login-reset-password-otp-container">
                                      <input type="text" id="resetPasswordOtp2" name="otp2" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1" class="-digit-otp js-otp-input"
                                        data-separator-input="true" data-type="otp">
                                    </div>


                                    <div class="js-separator-container js-login-reset-password-otp-container">
                                      <input type="text" id="resetPasswordOtp3" name="otp3" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1" class="-digit-otp js-otp-input"
                                        data-separator-input="true" data-type="otp">
                                    </div>
                                  ...
                                  <div class="d-none js-keypad-number-wrapper">
                                    ...
                                    <div class="x-keypad-number-container">
                                      <div class="-btn-group-wrapper">
                                        ...
                                        <button class="btn -btn js-keypad-btn -btn-backspace" type="button" data-key="backspace" data-target="#resetPasswordOtp0"
                                          data-options="{&quot;maxLength&quot;:4,&quot;inputContainer&quot;:&quot;.js-separator-container.js-login-reset-password-otp-container&quot;,&quot;targetSubmitForm&quot;:&quot;js-reset-password-v3-otp-form&quot;}">
                          ...
                          <div class="x-modal-separator-container x-form-register">
                            <div class="-top ">
                              ...
                              <div data-animatable="fadeInRegister" data-offset="0" class="-animatable-container -password-body animated fadeInRegister">
                                <form method="post" data-register-v3-form="/_ajax_/v3/reset-password/set-password/_resetPasswordSetPassword" data-register-step="resetPasswordSetPassword"
                                  ...
                                  <div class="d-flex -password-input-container js-register-v3-input-group">
                                    ...
                                    <div class="js-separator-container js-reset-password-container">
                                      <input type="password" id="resetPasswordSetPassword_1" name="resetPasswordSetPassword_1" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1"
                                        class="-digit-password js-otp-input" data-separator-input="true" data-type="set_password">
                                    </div>


                                    <div class="js-separator-container js-reset-password-container">
                                      <input type="password" id="resetPasswordSetPassword_2" name="resetPasswordSetPassword_2" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1"
                                        class="-digit-password js-otp-input" data-separator-input="true" data-type="set_password">
                                    </div>


                                    <div class="js-separator-container js-reset-password-container">
                                      <input type="password" id="resetPasswordSetPassword_3" name="resetPasswordSetPassword_3" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1"
                                        class="-digit-password js-otp-input" data-separator-input="true" data-type="set_password">
                                    </div>


                                    <div class="js-separator-container js-reset-password-container">
                                      <input type="password" id="resetPasswordSetPassword_4" name="resetPasswordSetPassword_4" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1"
                                        class="-digit-password js-otp-input" data-separator-input="true" data-type="set_password">
                                    </div>


                                    <div class="js-separator-container js-reset-password-container">
                                      <input type="password" id="resetPasswordSetPassword_5" name="resetPasswordSetPassword_5" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1"
                                        class="-digit-password js-otp-input" data-separator-input="true" data-type="set_password">
                                    </div>


                                    <div class="js-separator-container js-reset-password-container">
                                      <input type="password" id="resetPasswordSetPassword_6" name="resetPasswordSetPassword_6" inputmode="text" readonly="" pattern="[0-9]*" autofocus="1"
                                        class="-digit-password js-otp-input" data-separator-input="true" data-type="set_password">
                                    </div>
                                  ...
                                  <div class="d-none js-keypad-number-wrapper">
                                    ...
                                    <div class="x-keypad-number-container">
                                      <div class="-btn-group-wrapper">
                                        ...
                                        <button class="btn -btn js-keypad-btn -btn-backspace" type="button" data-key="backspace" data-target="#resetPasswordSetPassword_1"
                                          data-options="{&quot;maxLength&quot;:6,&quot;inputContainer&quot;:&quot;.js-separator-container.js-reset-password-container&quot;}">
                                          <i class="fas fa-backspace"></i>
                                        </button>
                                      </div>
                        ...
                        <div data-animatable="fadeInRegister" data-offset="0" class="col animated fadeInRegister">
                          <div class="text-center d-flex flex-column justify-content-center h-100">
                            <div class="text-center">
                              ...
                              <img alt="สมัครสมาชิก SUCCESS" class="js-ic-success -success-ic img-fluid" width="150" height="150" src="./assets/images/animated-register-success.png">
                            </div>
                              ...
                              <div data-animatable="fadeInModal" data-offset="0" class="-animatable-container -password-body animated fadeInModal">
                                <div class="d-flex -password-input-container js-register-v3-input-group">
                                  ...
                                  <div class="js-separator-container js-change-password-container">
                                    <input type="text" id="currentPassword_1" name="currentPassword_1" readonly="" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input"
                                      data-separator-input="true" data-type="current_set_password">
                                  </div>


                                  <div class="js-separator-container js-change-password-container">
                                    <input type="text" id="currentPassword_2" name="currentPassword_2" readonly="" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input"
                                      data-separator-input="true" data-type="current_set_password">
                                  </div>


                                  <div class="js-separator-container js-change-password-container">
                                    <input type="text" id="currentPassword_3" name="currentPassword_3" readonly="" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input"
                                      data-separator-input="true" data-type="current_set_password">
                                  </div>


                                  <div class="js-separator-container js-change-password-container">
                                    <input type="text" id="currentPassword_4" name="currentPassword_4" readonly="" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input"
                                      data-separator-input="true" data-type="current_set_password">
                                  </div>


                                  <div class="js-separator-container js-change-password-container">
                                    <input type="text" id="currentPassword_5" name="currentPassword_5" readonly="" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input"
                                      data-separator-input="true" data-type="current_set_password">
                                  </div>


                                  <div class="js-separator-container js-change-password-container">
                                    <input type="text" id="currentPassword_6" name="currentPassword_6" readonly="" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input"
                                      data-separator-input="true" data-type="current_set_password">
                                  </div>
                                ...
                                <div class="text-center">
                                  <button type="button" class="btn -submit btn-primary my-lg-3 mt-0 js-current-password-button" onclick="$('a[href=\'#tab-content-newPassword\']').click();">
                                    ยืนยัน
                                  </button>
                                </div>
                              </div>
                              ...
                              <div data-animatable="fadeInModal" data-offset="0" class="-animatable-container -password-body animated fadeInModal">
                                <div class="d-flex -password-input-container js-register-v3-input-group">
                                  ...
                                  <div class="js-separator-container js-new-password-container">
                                    <input type="text" id="newPassword_1" name="newPassword_1" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input" data-separator-input="true"
                                      data-type="set_new_password" required="">
                                  </div>


                                  <div class="js-separator-container js-new-password-container">
                                    <input type="text" id="newPassword_2" name="newPassword_2" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input" data-separator-input="true"
                                      data-type="set_new_password" required="">
                                  </div>


                                  <div class="js-separator-container js-new-password-container">
                                    <input type="text" id="newPassword_3" name="newPassword_3" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input" data-separator-input="true"
                                      data-type="set_new_password" required="">
                                  </div>


                                  <div class="js-separator-container js-new-password-container">
                                    <input type="text" id="newPassword_4" name="newPassword_4" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input" data-separator-input="true"
                                      data-type="set_new_password" required="">
                                  </div>


                                  <div class="js-separator-container js-new-password-container">
                                    <input type="text" id="newPassword_5" name="newPassword_5" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input" data-separator-input="true"
                                      data-type="set_new_password" required="">
                                  </div>


                                  <div class="js-separator-container js-new-password-container">
                                    <input type="text" id="newPassword_6" name="newPassword_6" inputmode="text" pattern="[0-9]*" class="-digit-password js-otp-input" data-separator-input="true"
                                      data-type="set_new_password" required="">
                                  </div>
